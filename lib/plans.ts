...
export const PLANS: Plan[] = [
  {
    ...
    taglineAr: 'ابدأ استعدادك لامتحان PMP (ECO 2026)',
    icon: '🌱',
  ...
  },
  {
    ...
    taglineAr: 'عدة الاستعداد الكاملة لامتحان PMP (ECO 2026)',
    icon: '⚡',
  ...
  },
  {
    ...
    taglineAr: 'أقصى دعم للمرشحين الجادّين لامتحان PMP (ECO 2026)',
    icon: '💎',
