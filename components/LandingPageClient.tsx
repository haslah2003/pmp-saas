...
const copy = {
  ...
  ar: {
    ...
    hero: {
      badge1: "PMBOK 8 + ECO 2026",
      badge2: "اختبار PMP الجديد",
      h1a: "اجتز اختبار PMP الجديد",
      h1b: "بالعربية أو ",
      h1c: "الإنجليزية",
      h1d: "",
      sub: "تحضير مركّز للاختبار الجديد PMP — PMBOK 8 + ECO 2026 — بالعربية والإنجليزية. تدرّب على أكثر من 1,200 سؤال ثنائي اللغة مع شروحات ذكية وتتبّع للجاهزية مصمّم للاختبار الحالي.",
    ...
    how: {
      label: "كيف يعمل",
      title: "أربع خطوات للجاهزية لاختبار PMP (ECO 2026)",
      steps: [
        { num: "01", title: "اختر مسار اختبارك", desc: "ابدأ على مسار ECO 2026 — اختبار PMP الحالي." },
        ...
        { num: "04", title: "اختتم بتركيز", desc: "رسّخ المجالات الضعيفة وادخل الاختبار بثقة." },
      ],
    },
    bridge: {
      label: "الجسر 7 ← 8",
      title: "حاولت اجتياز اختبار PMBOK 7 ولم تتمكن؟",
      sub: "لا حاجة للبدء من الصفر. يركّز وضع الجسر على ما تغيّر فقط من PMBOK 7 إلى PMBOK 8 — لتحوّل التحضير الذي أنجزته إلى نجاح في اختبار ECO 2026 الجديد.",
      points: [
        { icon: "🔄", title: "ما تغيّر فقط", desc: "مفاهيم جديدة، ومبادئ مُدمجة، ومحتوى مُلغى — دون إعادة البدء بالكامل." },
        { icon: "⚖️", title: "مجالات مُعاد وزنها", desc: "أتقن التحولات — مثل ارتفاع مجال بيئة الأعمال من 8% إلى 26% في الاختبار الجديد." },
    ...
    pricing: {
      label: "الأسعار",
      title: "اختر خطتك لاختبار PMP (ECO 2026)",
      sub: "تحضير مركّز للاختبار الجديد PMP (PMBOK 8 + ECO 2026). يمكنك الترقية في أي وقت حسب احتياجك التحضيري.",
      monthly: "شهري",
      ...
      plans: [
        { name: "أساسي", emoji: "🚀", tagline: "ابدأ تحضيرك لاختبار PMP (ECO 2026)", monthly: 29, annual: 79, annualSave: "وفّر 9%", features: ["مكتبة دروس ECO 2026 الكاملة", "المعلم الذكي — جلسات غير محدودة", "محرك التمارين — مجموعات أسئلة مركزة", "لوحة تتبع التقدم", "خرائط ذهنية تفاعلية", "إطار PMBOK 8 + ECO 2026"], cta: "احصل على الأساسي", popular: false },
        { name: "قياسي", emoji: "⚡", tagline: "عدة كاملة لاختبار PMP (ECO 2026)", monthly: 49, annual: 129, annualSave: "وفّر 12%", features: ["كل شيء في الأساسي ✅", "أكثر من 1,200 سؤال ممارسة ثنائي اللغة", "اختبار محاكاة (180 سؤالًا)", "تقرير خبير وتحليل نقاط الضعف", "توسعات تعمّق بالذكاء الاصطناعي", "إطار PMBOK 8 + ECO 2026", "تحديثات محتوى ذات أولوية"], cta: "احصل على القياسي", popular: true },
        { name: "احترافي", emoji: "💎", tagline: "دعم أقصى للمرشحين الجادّين", monthly: 79, annual: 199, annualSave: "وفّر 16%", features: ["كل شيء في القياسي ✅", "دعم ذو أولوية لاختبار ECO 2026", "أكثر من 1,200 سؤال ممارسة ثنائي اللغة", "خطة دراسة مخصّصة", "دعم ذو أولوية", "تحديثات محتوى مدى الحياة", "مجموعة أدوات جاهزية الاختبار"], cta: "احصل على الاحترافي", popular: false },
      ],
    },
    compare: {
      label: "المقارنة",
    ...
    finalCta: {
      title: "هل أنت جاهز لاجتياز اختبار PMP الجديد؟",
      sub: "تدرّب، شخّص نقاط ضعفك، وادخل اختبار PMP الجديد بثقة.",
