...
const copy = {
  en: {
    ...
    hero: {
      badge1: "PMBOK 8 + ECO 2026",
      badge2: "The New PMP Exam",
      h1a: "Pass the new PMP exam",
      h1b: "in ",
      h1c: "English or Arabic",
      h1d: "",
      sub: "Focused preparation for the new PMP exam — PMBOK 8 + ECO 2026 — in both English and Arabic. Practice with 1,200+ bilingual questions, AI explanations, and readiness tracking built for the current exam.",
    ...
    features: {
      ...
      items: [
        { icon: "🤖", title: "AI tutor", desc: "Ask in English or Arabic and get exam-focused explanations aligned with PMBOK 8 + ECO 2026." },
        ...
        { icon: "📝", title: "Practice engine", desc: "Train with 1,200+ bilingual current-exam questions and rationales that explain why the best answer is best." },
        ...
        { icon: "🎯", title: "Current-exam focus", desc: "Stay focused on PMBOK 8 + ECO 2026 and practice for the PMP exam version candidates are taking now." },
      ],
    },
    how: {
      label: "How it works",
      title: "Four steps to PMP (ECO 2026) readiness",
      steps: [
        { num: "01", title: "Choose your exam path", desc: "Start on the ECO 2026 path: the current PMP exam." },
    ...
    pricing: {
      ...
      sub: "Focused preparation for the new PMP exam (PMBOK 8 + ECO 2026). Upgrade anytime as your preparation needs grow.",
      monthly: "Monthly",
      ...
      plans: [
        { name: "Basic", emoji: "🚀", tagline: "Start your PMP (ECO 2026) preparation", monthly: 29, annual: 79, annualSave: "Save 9%", features: ["Full ECO 2026 course library", "AI Tutor — unlimited sessions", "Practice Engine — focused question sets", "Progress Dashboard", "Interactive Mind Maps", "PMBOK 8 + ECO 2026 framework"], cta: "Get Basic", popular: false },
        { name: "Standard", emoji: "⚡", tagline: "Complete PMP (ECO 2026) toolkit", monthly: 49, annual: 129, annualSave: "Save 12%", features: ["Everything in Basic ✅", "1,200+ bilingual practice questions", "Mock Exam (180 questions)", "Guru Report & weak area analysis", "Go Deeper AI expansions", "PMBOK 8 + ECO 2026 framework", "Priority content updates"], cta: "Get Standard", popular: true },
        { name: "Professional", emoji: "💎", tagline: "Maximum support for serious PMP candidates", monthly: 79, annual: 199, annualSave: "Save 16%", features: ["Everything in Standard ✅", "Priority ECO 2026 support", "1,200+ bilingual practice questions", "Personalised study plan", "Priority support", "Lifetime content updates", "Exam-readiness toolkit"], cta: "Get Professional", popular: false },
      ],
    },
    compare: {
      label: "Comparison",
    ...
    finalCta: {
      title: "Ready to pass the new PMP exam?",
      sub: "Practice, diagnose weak areas, and walk into the new PMP exam prepared.",
  ...
  ar: {
    ...
    hero: {
      badge1: "PMBOK 8 + ECO 2026",
      badge2: "امتحان PMP الجديد",
      h1a: "اجتز امتحان PMP الجديد",
      h1b: "بالعربية أو ",
      h1c: "الإنجليزية",
      h1d: "",
      sub: "تحضير مركّز للامتحان الجديد PMP — PMBOK 8 + ECO 2026 — بالعربية والإنجليزية. تدرّب على أكثر من 1,200 سؤال ثنائي اللغة مع شروحات ذكية وتتبّع للجاهزية مصمّم للامتحان الحالي.",
    ...
    features: {
      ...
      items: [
        { icon: "🤖", title: "المعلم الذكي", desc: "اسأل بالعربية أو الإنجليزية واحصل على شروحات مركزة للاختبار ومتوافقة مع PMBOK 8 + ECO 2026." },
        ...
        { icon: "📝", title: "محرك التمارين", desc: "تدرّب على 1,200+ سؤالًا ثنائي اللغة للاختبار الحالي مع تفسيرات توضّح لماذا تكون الإجابة الأفضل هي الأفضل." },
        ...
        { icon: "🎯", title: "تركيز على الاختبار الحالي", desc: "حافظ على تركيزك على PMBOK 8 + ECO 2026 وتدرّب على إصدار اختبار PMP الذي يستهدفه المرشحون الآن." },
      ],
    },
    how: {
      label: "كيف يعمل",
      title: "أربع خطوات للجاهزية لامتحان PMP (ECO 2026)",
      steps: [
        { num: "01", title: "اختر مسار اختبارك", desc: "ابدأ على مسار ECO 2026 — امتحان PMP الحالي." },
    ...
    pricing: {
      label: "الأسعار",
      title: "اختر خطتك لامتحان PMP (ECO 2026)",
      sub: "تحضير مركّز للامتحان الجديد PMP (PMBOK 8 + ECO 2026). يمكنك الترقية في أي وقت حسب احتياجك التحضيري.",
      monthly: "شهري",
      ...
      plans: [
        { name: "أساسي", emoji: "🚀", tagline: "ابدأ تحضيرك لامتحان PMP (ECO 2026)", monthly: 29, annual: 79, annualSave: "وفّر 9%", features: ["مكتبة دروس ECO 2026 الكاملة", "المعلم الذكي — جلسات غير محدودة", "محرك التمارين — مجموعات أسئلة مركزة", "لوحة تتبع التقدم", "خرائط ذهنية تفاعلية", "إطار PMBOK 8 + ECO 2026"], cta: "احصل على الأساسي", popular: false },
        { name: "قياسي", emoji: "⚡", tagline: "عدة كاملة لامتحان PMP (ECO 2026)", monthly: 49, annual: 129, annualSave: "وفّر 12%", features: ["كل شيء في الأساسي ✅", "أكثر من 1,200 سؤال ممارسة ثنائي اللغة", "اختبار محاكاة (180 سؤالًا)", "تقرير خبير وتحليل نقاط الضعف", "توسعات تعمّق بالذكاء الاصطناعي", "إطار PMBOK 8 + ECO 2026", "تحديثات محتوى ذات أولوية"], cta: "احصل على القياسي", popular: true },
        { name: "احترافي", emoji: "💎", tagline: "دعم أقصى للمرشحين الجادّين", monthly: 79, annual: 199, annualSave: "وفّر 16%", features: ["كل شيء في القياسي ✅", "دعم ذو أولوية لامتحان ECO 2026", "أكثر من 1,200 سؤال ممارسة ثنائي اللغة", "خطة دراسة مخصّصة", "دعم ذو أولوية", "تحديثات محتوى مدى الحياة", "مجموعة أدوات جاهزية الاختبار"], cta: "احصل على الاحترافي", popular: false },
      ],
    },
    compare: {
      label: "المقارنة",
      title: "لماذا يناسب AiTutorZ تحضيرك لامتحان PMP",
    ...
    faq: {
      ...
      items: [
        { q: "هل المنصة متوافقة مع امتحان PMP الحالي؟", a: "نعم. المنصة مبنية على PMBOK 8 + ECO 2026، امتحان PMP الحالي." },
        { q: "هل تغطي المنصة امتحان 2026 الجديد؟", a: "نعم. المنصة متوافقة بالكامل مع PMBOK 8 + ECO 2026، الامتحان الساري الآن." },
        ...
        { q: "درست امتحان PMBOK 7 القديم، هل يفيدني هذا؟", a: "نعم. يركّز وضع الجسر (Bridge) على ما تغيّر من PMBOK 7 إلى PMBOK 8 لتحويل تحضيرك بسرعة." },
      ],
    },
    finalCta: {
      title: "هل أنت جاهز لاجتياز امتحان PMP الجديد؟",
      sub: "تدرّب، شخّص نقاط ضعفك، وادخل امتحان PMP الجديد بثقة.",
